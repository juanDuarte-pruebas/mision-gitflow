...
>  **Nota:** Este es un proyecto de práctica cuyo objetivo principal es **aprender y demostrar el flujo de trabajo Git Flow** (ramas, features, releases, hotfixes y resolución de conflictos). El sistema de inventario es el pretexto funcional para ejercitar estas habilidades, no el foco central del ejercicio.
